...
import src.phonis.survival.commands.ChunkRemover;
import src.phonis.survival.commands.ChunkShower;
import src.phonis.survival.commands.CraftGetter;
import src.phonis.survival.commands.Finder;
import src.phonis.survival.commands.Inspector;
import src.phonis.survival.commands.LocationBroadcaster;
import src.phonis.survival.commands.RadiusLoader;
import src.phonis.survival.commands.RadiusUnloader;
import src.phonis.survival.commands.SleepDenier;
import src.phonis.survival.commands.Sleeper;
import src.phonis.survival.commands.SlimemapShower;
import src.phonis.survival.commands.SpectatorToggler;
import src.phonis.survival.commands.TodoAdder;
import src.phonis.survival.commands.TodoLister;
import src.phonis.survival.commands.TodoRemover;
import src.phonis.survival.commands.TogglePistonAnimations;
import src.phonis.survival.commands.WaypointLister;
import src.phonis.survival.commands.WaypointPosUpdater;
import src.phonis.survival.commands.WaypointRemover;
import src.phonis.survival.commands.WaypointSetter;
import src.phonis.survival.commands.YawSnapper;
